...
static var sleepyroom_Convos_Dict = {
	"Prologue": {
		...
		6: { "speaker": "", "dialogue": "The pain of that movement though is enough to shock you out of the panic gripping your body cold – you take the opportunity to force a few intentionally slow breaths through your lungs. [i]Focus, soldier.[/i] You start with the simple facts to ground yourself, like you were taught.", "goto": 7 },
		...
		72: { "speaker": "", "dialogue": "Heresy thoughts. You had answered Him - of course you answered. There is no questioning the Divine, only being the enactment of His word.", "goto": 8 },				
		...
		11: { "speaker": "", "dialogue": "Your fingers drift up to your chest, touching bandages you don’t remember putting on and recoiling from an aching wound you don’t remember getting. 
	...
	"Bed": {
		1: { "speaker": "none", "dialogue": "The sheets for this bed are worn in the way only well loved fabric can be - soft to the touch, but the linen hasn't quite thinned yet.", "goto": 2 },
	...
	"Note": {
		...
		2: { "speaker": "Witch_hide", "dialogue": "Greetings, my knight,
				We will meet in person soon - while I wished to be here myself to make the task of waking and acclimating that much easier, the needs of the day call to me.", 
		...
		15: { "speaker": "", "dialogue": "...Still strange she didn't sign by a name, you muse. You wonder if you can find that.", "goto": 16 },
	...
	"SidetableLeft": {
		...
		2: { "speaker": "", "dialogue": "The potted plant with bubbled leaves makes your nose wrinkle. You remember, in your infinite wisdom as a child, eating some of the bright green pearls. The dreams you'd had were as vivid as waking - and the scolding you'd gotten about poisoning yourself had made you never touch them again.", "goto": 3 },				
		3: { "speaker": "", "dialogue": "You attempt to get in the drawer, but a light zaps like static bolts up your arm. Seems like somebody didn't want you going through these particular personal belongings.", "end": true },
		
		10: { "speaker": "", "dialogue": "A String-of-Dreams sits on the sidetable - you'd never known this is what the plant actually looked like. You'd believed the Capital's salvekeepers at their word when they'd said the plant was poisonous and never thought much more of it - why would you?", "goto": 11 },		
	...
	"Sword": {
		...
		4: { "speaker": "", "dialogue": "Blessed steel shouldn’t break like this. The Divine Himself imbues it, the holy blessing from His hands making it one of the strongest materials known to man – you’ve cut through solid marble like butter, before. This should have been easy.", "goto": 5 },
		5: { "speaker": "", "dialogue": "The discoloration on the metal is worrying too; it’s tarnished like a cheap mirror, blackening at its edges. You’ve spent too much time polishing its length and sharpening its blade to believe for a second that the flaking darkness is due to neglect.", "goto": 6 },
	...
	"ToyChest": {
			...
			4: { "speaker": "", "dialogue": "The first is a soft green-to-blue ombre dildo that looks like a vine-covered branch. The colour reminds you distinctly of the dryads you would see while traveling, in those few moments before the braying horses and clanging steel would make them disappear from view. It's the smallest of the bunch, but looks like it would fit comfortably in your hand.", "goto": 5 },
			5: { "speaker": "", "dialogue": "The second has clearly been sculpted to look like a tongue, with a colour fading from purple at the 'gums', to red, to a vibrant yellow at the end. The base has a snout and (blunt) teeth sculpted onto it - between that and the implied rough texture on the tongue itself, this appears to be modelled on a manticore.", "goto": 6 },
			...
			106: { "speaker": "", "dialogue": "You strike it repeatedly, following the drag of electricity over and over again. Soon enough you're pounding into your body with a fever, chasing the feeling of those sparks clashing into each other, into the pleasure you're pursuing rising into a fever pitch that you can't escape. You fuck yourself, over and over and over until-", "goto": 107 },
			...
			"choice": {
			 ...
			 120: { "speaker": "", "dialogue": "No, you do actually want to stop now. You quickly rinse off the dildo in the sink, before placing it back with its brethren.
			...
			203: { "speaker": "", "dialogue": "This dildo you know you'll actually need the lube for - you run it over the broad form until it feels nice and slick in your hands. You're thankful you did, too - you bite your lip as the broad tip of the 'tongue' presses up against the flutter of your hole. Already you're imagining it inside you, the stretch of it against your walls, the feeling of that broad, flat surface dragging against your G-spot.", "goto": 204 },
			...
			205: { "speaker": "", "dialogue": "But do you have to have words for it? You're not sure you do. You just have to rock this thing deeper and deeper inside of you, fucking yourself in broader and broader strokes until you feel the moulded nose kiss up against your cunt. Being able to fit the broad length of it inside you though doesn't slow you down though - if anything? It only drives your want up even higher.", "goto": 206 },
			206: { "speaker": "", "dialogue": "Thrust after thrust, the rough surface of the moulded tongue drags compounding shocks out of the sensitive walls clenching down around it. It's too easy to lose yourself to this gorgeous pleasure, to the thrill of fucking yourself in a way you shouldn't be. And oh - the thought of being a display of pleasure like that? That's what finally tips you over the edge.", "goto": 207 },
			...
			310: { "speaker": "", "dialogue": "Divine help you - you know you should have resisted. But it just feels so [i]good[/i] to finally indulge in pleasure like this again. You feel greedy, high on it - an addict with their sobriety broken, seeing just how far they can fall.", "goto": 668 },
			...
			672: { "speaker": "", "dialogue": "It presses through. You gasp out as the massive cock pierces you, deeper than anything before it. 
	...
	"WindowFire": {
		...
		2: { "speaker": "none", "dialogue": "The glass work is beautiful - and you can tell at just a glace it will be too difficult to smash through, were you to try and escape out it.", "end": true },
		}, 
	...
	"lockedDoor": {
		...
		12: { "speaker": "", "dialogue": "You've trained for this exact moment. Steadying yourself, you kick the door open.", "fadeToBlack":true, "playEnding": SaveData_EndingTracker.EndingEnum.CAPTURED },											
	},
	...
	"ChestOfDrawers":{
		...
		102: { "speaker": "", "dialogue": "The second is a long sleeved, hooded crop top and panties - the sleeves have embroidered paw pads on the sides, while the hood sports a pair of cat ears. It is all made out of a delightfully soft auburn velvet, in a shade remarkably similar to your hair colour. The panties have a hole on the back - you realise with a flush it's to fit the plug of a long, fluffy tail. 
		...
		# haha nice try scrub
			...
			# bikiki - cow
			200: { "speaker": "", "dialogue": "There's a simplicity about the bikini that seems the most logical here - no fluff, no squeaky fabrics or anything extra. You could almost fool yourself into thinking this was a completely appropriate set of underwear if it wasn't for the pattern, which is just fine by you. The underwear goes on easily, settling on your hips like the set was made for you. ", "goto": 201 },
			...
			208: { "speaker": "", "dialogue": "(You tell yourself that. You know that's a lie - you've always wondered what it would be like to have nice, plush tits. Maybe you could just consider this a benefit of the whole experience, when you're done...)", 
