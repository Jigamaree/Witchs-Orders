...
static var thePit_Convos_Dict = {
	...
	"thePit": {
			...
			112: { "speaker": "", "dialogue": "They weren't asking, anymore.",  "specialAction": "drag", "fadeToBlack": true, "playEnding": SaveData_EndingTracker.EndingEnum.TENTACLE_BAIT },	
				...
				201: { "speaker": "", "dialogue": "If it wasn't using that advantage, that meant it saw you as valuable - maybe even just any human that came in as valuable. Would this creature damage sometime it saw as valuable? There's just something on the air that makes you want to say yes.", "goto": 202 },
				202: { "speaker": "", "dialogue": "You've always been good at sensing places of power, at finding magical artifacts dating back to antiquity that would of surely harmed somebody if it'd gotten into the wrong hands. You'd always called that a sixth sense to protect people... 
	...
	"FuckThatSquid": {
				1: { "speaker": "", "dialogue": "The tentacles are on you immediately - but they're not unkind. Instead they curl around your body like they're greeting somebody coming home once more instead of meeting you for the first time. You were expecting the limbs to be cold to the touch - toad-like, even - but you're surprised to find it pleasantly warm to your skin instead. You hold out a hand experimentally; one of the tentacles runs against the underside of it in turn, the even, solid pressure more of a comfort than you expected.", "goto": 2 },
				...
				6: { "speaker": "", "dialogue": "The tentacle in your mouth fucks shallowly at first, nothing more than a pleasant slide against the tongue - but it only takes a few thrust for you to realise that it's quickly becoming not just mere stimulation anymore. The more the tentacle slides against your tongue, the roof of your mouth, brushes against the back of your mouth, the more nerve ending you didn't even know were there come to life. ", "goto": 7 },
				7: { "speaker": "", "dialogue": "Soon you're groaning on each thrust into your mouth, desperately craning your head to take each thrust as it's offered to you. More, more - deeper, harder, faster. You groan as your mouth is wrenched opened further, as the tentacle fucks deep enough into your throat to block off your air. While the world spins around you, your cunt only pulses with all the more arousal.", "goto": 8 },
				...
				12: { "speaker": "", "dialogue": "When you come to, you've no longer got tentacles fucking you from every angle; instead you seem to be resting on what appears to be functionally a bed of tentacles. The light from the single blue torch shines somewhere far above you; about you, the body of the beast twist and coils in slow motion; a pleasure just as bone deep as the one you feel, you're sure.", "goto": 13 },
