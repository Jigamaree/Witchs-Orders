...
static var convos_Dict = {
	...
	"Cheese": {
			...
			#have eaten
			1: { "speaker": "none", "dialogue": "Several large blocks of cheese sit on the counter, the scent of it is light and sweet. While it smells delicious, you're not interested in eating anything more right now.", "end": true },
			#could eat
	...
	"Milk": {
			...
			#could eat
			2: { "speaker": "", "dialogue": "While not typically a meal - and not usually your go-to meal, either - a glass of creamy milk would easily keep you going food-wise. You can tell just by looking it that it's as fresh as it comes.",
					"choice": {
							"c1": { "choice": "Find something else", "goto": 3 },
	...
	"Sacks": {
		1: { "speaker": "none", "dialogue": "Large sacks of flour sit on the ground - you can tell this is the finely ground stuff, the sort that can sit for months without going back. It doesn't have as much flavor as freshly milled flour - but it'll make as decent a loaf as any.", "end": true }
		},				
