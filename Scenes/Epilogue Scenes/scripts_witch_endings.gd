...
static var endingsDict = {
		...
		#specialEnding_didNothing
	{
		...
		10: { "speaker": "The Witch", "emote": "amused", "dialogue": "It's okay, Allie. I know you've been working so hard, for so long. A pretty girl like you should have never ended up as a guardswoman, anyway - of course, when somebody finally rid you of that silly little sword and armour, you could barely think straight. Isn't that right?", "goto": 11 },
		11: { "speaker": "", "dialogue": "Gods above, you want to argue. You [b]should[/b] argue - but you're oh so very tired, and the woman in front of you is just... So, so pretty.",
	...
	"BetterNotToThink":
	{
				...
				13: { "speaker": "The Witch", "dialogue": "...but you didn't tend to all its needs, did you?", "goto": 14 },
				...
				17: { "speaker": "", "dialogue": "More definitive scratching.", 				
				"checkSaveVariable": { 
				...
				It's beautiful, in its own frightful way - and it makes some quiet, submissive part of you squirm.", "goto": 21 },
				...
				22: { "speaker": "", "dialogue": "You want to recoil at the language - instead, you're frankly too baffled to respond. You're a decorated soldier, you've slain monster and man alike. Why is she speaking to you, a grown woman, this way...?", "goto": 23 },
	...
	"BetterNotToThinkSex":
	{
				...
				6: { "speaker": "", "dialogue": "She catches your eyes with hers - they draw you in so effortlessly. Is it magnetic attraction, or something else? You're not entirely sure.", "goto": 7 },
				...
				29: { "speaker": "", "dialogue": "You feel something press to your lips - easily, obediently, you drink, letting the bubblegum sweet liquid flow over your tongue. Heat blooms in its wake - the kind that makes your whimper and rub your thighs together. It tastes like sparks, like sugar - you're quickly running out of words to describe it except good.", "goto": 30 },
				...
				33: { "speaker": "The Witch", "dialogue": "You don't need to do that anymore - not when you can think about nicer things. Like that heat between your thighs, or my cock between your lips. Such a pretty, pretty little thing you're going to be for me.", "goto": 34 },
				34: { "speaker": "", "dialogue": "The hand against your cheek turns instructive - a tap on the cheek to turn your face outward, to let your mouth drop open. You're aware of how good it is to have the witch slide into your mouth like this, the thick length of her cock quickly leaving you drooling and dazed. You're not even doing anything, as she fucks into your mouth like this.", "goto": 35 },
...
#successfully completed all
	"TrueEnd":
	{
		...
		7: { "speaker": "The Witch", "dialogue": "It's hard to describe, isn't it? I've tried to explain it to other apprentices of mine before, but I've found it's a process better experienced for one's self.", "goto": 8 },
	...
	"default_ending_setup": ##covers beginning of imp, cow, pet, and failed apprentice	
	{
		...
		101: { "speaker": "The Witch", "dialogue": "You, my dear, are a precious and strange thing. I would have thought by now that I'd know what calls to your heart - what needs that pretty little face of yours desires. But your results are... Muddled.", "goto": 102 },
		102: { "speaker": "The Witch", "dialogue": "But I forgot the most important factor of all this: you.", "goto": 103 },
		103: { "speaker": "", "dialogue": "She tips your head up with one finger.", "goto": 104 },
		...
		107: { "speaker": "MC", "dialogue": "I'm a trained soldier. I could- protect you. Hunt for you. Train under you, maybe. Surely there's other options. ", "goto": 108 },
